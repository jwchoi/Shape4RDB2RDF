...
public class LocalDBSchemaFactory {
	public static LocalDBSchema generateLocalDatabaseMetaData(DBBridge dbBridge) {
		String catalog = dbBridge.getConnectedCatalog();
		LocalDBSchema localDBMD = new LocalDBSchema(catalog);
