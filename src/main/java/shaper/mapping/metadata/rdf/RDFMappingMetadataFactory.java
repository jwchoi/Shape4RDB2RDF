...
public class RDFMappingMetadataFactory {
	public static RDFMappingMetadata generateMappingMetaData() {
		RDFMappingMetadata mappingMD = new RDFMappingMetadata(URI.create(Shaper.baseURI));
