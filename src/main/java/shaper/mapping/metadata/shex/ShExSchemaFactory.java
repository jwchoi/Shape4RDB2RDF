...
public class ShExSchemaFactory {
    ...
    // R2RML
    public static ShExSchema buildShExSchemaModel(R2RMLModel r2rmlModel) {
    ...
    //Direct Mapping
    public static ShExSchema buildShExSchemaModel() {
        ...
        for(String table : tables) {
            ...
            Set<String> refConstraints = Shaper.localDBSchema.getRefConstraints(table);
            ...
            Set<DBRefConstraint> refConstraintsPointingTo = Shaper.localDBSchema.getRefConstraintsPointingTo(table);
